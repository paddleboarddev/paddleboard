...
[
  ; PaddleBoard: switched from anonymous "null" token to the
  ; `(null_literal)` named node — `tree-sitter-kotlin-codanna` 0.3.9
  ; models null as a named node, not an anonymous token, and the
  ; quoted form fails query loading.
