...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "PaddleBoard Dev Instance Running",
        ReleaseChannel::Nightly => "PaddleBoard Nightly Instance Running",
        ReleaseChannel::Preview => "PaddleBoard Preview Instance Running",
        ReleaseChannel::Stable => "PaddleBoard Stable Instance Running",
    }
}
