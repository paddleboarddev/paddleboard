    ...
    vec![
        Menu {
            ...
            items: vec![
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide PaddleBoard", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit PaddleBoard", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            ...
            items: vec![
                ...
                MenuItem::action("Open Recent…", paddleboard_actions::OpenRecent::default()),
                MenuItem::action("Open Remote…", paddleboard_actions::OpenRemote::default()),
                MenuItem::separator(),
