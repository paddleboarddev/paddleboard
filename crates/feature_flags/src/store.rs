...
use crate::{FeatureFlag, FeatureFlagValue, FeatureFlagsSettings, PADDLEBOARD_DISABLE_STAFF};
...
impl FeatureFlagStore {
    ...
    /// Debug builds are always treated as staff, and `PADDLEBOARD_DISABLE_STAFF`
    /// forces the user to be treated as non-staff for testing.
    pub fn overrides_enabled(&self) -> bool {
        (cfg!(debug_assertions) || self.staff) && !*PADDLEBOARD_DISABLE_STAFF
    }
