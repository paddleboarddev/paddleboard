...
impl TokenUsage {
    pub fn ratio(&self) -> TokenUsageRatio {
        ...
        let warning_threshold: f32 = std::env::var("PADDLEBOARD_THREAD_WARNING_THRESHOLD")
...
mod tests {
    ...
    async fn test_url_elicitation_rejects_non_browser_urls(cx: &mut TestAppContext) {
        ...
        for invalid_url in [
            ...
            // PaddleBoard: our own scheme, not upstream's — the point of this case
            // is that the app's deep-link scheme is never treated as a browser URL,
            // and `zed://` would pass here without exercising that.
